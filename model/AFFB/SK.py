...
class AFF(nn.Module):
    def __init__(self,channel,reduction=16):
        ...
        self.att=B.CAMLayer(channel,reduction=reduction)
        ...
        self.c=B.conv_layer(channel, channel, 1)
    ...
    def forward(self, x1,x2):
        ...
        attention_vectors = attention_vectors.view(feats.shape[0], 2, -1, 1,1)
        attention_vectors = self.softmax(attention_vectors)*feats1
        out=torch.sum(attention_vectors,dim=1)
        out=self.c(out)
        return out
